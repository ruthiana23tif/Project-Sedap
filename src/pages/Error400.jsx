...
import img from "/img/baju1.jpg"; // Pastikan path gambar sesuai
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      <div className=" p-12 rounded-lg  flex flex-col md:flex-row items-center max-w-7xl w-full space-y-6 md:space-y-0 md:space-x-10">
        ...
        <div className="text-center md:text-left max-w-lg">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mt-4">400 - Bad Request</h2>
          <p className="text-gray-500 mt-4">
            The server could not understand your request. Please check the URL or try again later.
          </p>
          <Link 
            to="/" 
        ...
        <div className="w-72 h-auto md:w-96 mt-6 md:mt-0">
          <img src={img} alt="400 error" className="w-full h-auto rounded-lg shadow-md" />
        </div>
      </div>
    </div>
  );
