...
export default function Customers() {
  ...
  return (
    <div id="customers-container" className="p-6 space-y-8">
      <PageHeader title="Customers" breadcrumb={["Dashboard", "Customer List"]} />

      <div className="flex justify-normal">
        <Link
          to="/AddCustomer"
          className="flex items-center gap-2 px-6 py-2 bg-hijau text-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300"
        >
          + Tambah Customer
        </Link>
      </div>
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-r from-blue-100 to-blue-200 rounded-2xl p-6 shadow-lg">
          ...
          <p className="text-4xl font-extrabold text-blue-600">
            {customers.filter(customer => customer.loyalty === "Gold" || customer.loyalty === "Silver").length}
          </p>
        </div>
      </div>
